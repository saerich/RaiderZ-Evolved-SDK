...
TCHAR* ViewportTexture::GetObjectName() 
{ 
...
//From ReferenceMaker
RefResult ViewportTexture::NotifyRefChanged( Interval changeInt, RefTargetHandle hTarget, 

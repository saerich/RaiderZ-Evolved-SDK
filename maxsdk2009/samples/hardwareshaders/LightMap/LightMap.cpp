...
MaxSDK::Util::Path LightMapLightAccessor::GetPath() const	{
	return MaxSDK::Util::Path(mLightMap->light->bi.Name());
}

void LightMapLightAccessor::SetPath(const MaxSDK::Util::Path& aNewPath)	{
	mLightMap->SetLightmap(const_cast<TCHAR*>(aNewPath.GetCStr()));
}
...
MaxSDK::Util::Path LightMapDiffuseAccessor::GetPath() const	{
	return MaxSDK::Util::Path(mLightMap->diffuse->bi.Name());
}

void LightMapDiffuseAccessor::SetPath(const MaxSDK::Util::Path& aNewPath)	{
	mLightMap->SetDiffusemap(const_cast<TCHAR*>(aNewPath.GetCStr()));
}

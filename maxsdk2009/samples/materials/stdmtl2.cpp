...
void StdMtl2::BindParameter(const TCHAR *paramName, LPVOID value)
{
	...
	if(_tcscmp(paramName,_T("max_stdmtl2_1_ambient_color"))==0)
	{
		Color val;
...
//		val = pShader->GetAmbientClr(t);
	...
	else if(_tcscmp(paramName,_T("max_stdmtl2_1_diffuse_color"))==0)
	{
		Color val;
	...
	else if(_tcscmp(paramName,_T("max_stdmtl2_1_specular_color"))==0)
	{
		Color val;
		val = pShader->GetSpecularClr(t);
		*(D3DCOLORVALUE*)value = GetD3DColor(val);
	}	
	else if(_tcscmp(paramName,_T("max_stdmtl2_1_selfillumination_color"))==0)
	{
		Color val;
	...
	else if(_tcscmp(paramName,_T("max_stdmtl2_1_specular_shininess"))==0)
	{
		float val;
	...
	else if(_tcscmp(paramName,_T("max_stdmtl2_1_specular_scalar"))==0)
	{
		float val;
		val = pShader->GetSpecularLevel(t);
		*(float*)value = val;
	}	
	else if(_tcscmp(paramName,_T("max_stdmtl2_1_diffuse_scalar"))==0)
	{
		float val = 1.0f;
		*(float*)value = val;
	}	
	else if(_tcscmp(paramName,_T("max_stdmtl2_1_ambient_scalar"))==0)
	{
		float val = 1.0f;
		*(float*)value = val;
	}	
	else if(_tcscmp(paramName,_T("make_normal_amount"))==0)
	{
		float val;
		int id = StdIDToChannel( ID_BU );
	...
	else if(_tcscmp(paramName,_T("max_stdmtl2_1_opacity_scalar"))==0)
	{
		float val;
		val = GetOpacity(t);
		*(float*)value = val;
	}
	else if(_tcscmp(paramName,_T("max_stdmtl2_1_opacity_data"))==0)
	{
		D3DCOLORVALUE val;

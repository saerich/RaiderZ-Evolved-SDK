...
enum RenderCommand
{
    CMD_CREATE_MESH,        /*!< Create a mesh */
    CMD_DELETE_MESH,        /*!< Destroy a mesh */
    CMD_DELETE_OBJECT,      /*!< Destroy an object */
...
public:
    ...
    Platform::Mesh*             createMesh      (const Platform::Vector3* vertices, 
                                                 const Platform::Vector3* normals, 
                                                 const Platform::Vector3i* triangles, 
                                                 int nVertices, 
                                                 int nTriangles);
    void                        deleteMesh      (Platform::Mesh* mesh);

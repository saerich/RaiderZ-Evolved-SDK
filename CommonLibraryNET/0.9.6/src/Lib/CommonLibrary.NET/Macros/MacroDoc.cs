...
namespace ComLib.Macros
{
    ...
    public class MacroDocParser
    {
        ...
        /// </summary>
        public MacroDocParser() : this(null, "<", ">")
        {
        }
        ...
        public MacroDocParser(string tagPrefix, string openBracket, string closeBracket)
        {
        ...
        /// <returns></returns>
        public MacroDoc Parse(ITokenReader reader, bool parseTagsOnly)
        {
            _reader = reader;
            _reader.ReadChar();
            while(!_reader.IsEnd())

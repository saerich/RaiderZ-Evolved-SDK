...
extern TCHAR *GetString( int id, TCHAR* buf, int bufSize );
...
typedef BOOL (CALLBACK* WTCLOSE)(HCTX);
...
class PainterInterface :  public ReferenceTarget, public IPainterInterface_V7, public ViewportDisplayCallback

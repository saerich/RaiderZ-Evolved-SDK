...
#define MAXVER_INTERNALNAME "Sunlight\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Sunlight.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Sunlight system (plugin)\0"//should  be overidden on a per-dll level

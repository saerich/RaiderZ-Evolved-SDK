...
public:
	...
	BEGIN_MSG_MAP(CCaptureConfig)
		...
		COMMAND_HANDLER(IDC_BTN_PRESET_MNCAST, BN_CLICKED, OnBnClickedBtnPresetMncast)
...
public:
	...
	LRESULT OnBnClickedBtnPresetMncast(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/);

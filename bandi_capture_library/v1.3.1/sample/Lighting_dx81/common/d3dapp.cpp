...
static HMODULE g_hModD3D8 = NULL;
static LPDIRECT3DCREATE8 s_DynamicDirect3DCreate8 = NULL;
//-----------------------------------------------------------------------------
// Name: Create()
// Desc:
//-----------------------------------------------------------------------------
HRESULT CD3DApplication::Create( HINSTANCE hInstance )
{
	...
	if(g_hModD3D8 == NULL)
	{
		g_hModD3D8 = LoadLibrary(_T("d3d8.dll"));
		if(g_hModD3D8 == NULL)
			return E_FAIL;
	    
		s_DynamicDirect3DCreate8 = (LPDIRECT3DCREATE8)GetProcAddress(g_hModD3D8, "Direct3DCreate8");
		if(s_DynamicDirect3DCreate8 == NULL)
			return E_FAIL;
	}

    // Create the Direct3D object
    m_pD3D = s_DynamicDirect3DCreate8( D3D_SDK_VERSION );
    if( m_pD3D == NULL )

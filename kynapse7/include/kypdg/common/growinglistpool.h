...
#ifndef KyPdg_GrowingListPool_H
#define KyPdg_GrowingListPool_H

#include <kypathdata/generic/types.h>
#include "kypdg/common/growingpool.h"
#include <assert.h>
...
public:
	explicit GrowingListPool(KyUInt32 byteCountInChunk = 0) :
		m_lists(byteCountInChunk), m_nodes(byteCountInChunk), m_elementCount(0) {}
...
T* GrowingList<T, NbEl>::GetNew()
{
	...
	assert(m_countInLast >= 0 && m_countInLast < NbEl);
